...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; running Emacs in terminal. The font set here will be used for default an
